...
<body>
    <button class="back-btn" onclick="window.location.href='rekapan_pemeriksaan_tanah.php?id=' + new URLSearchParams(window.location.search).get('id_pekerjaan')">
        <svg viewBox="0 0 24 24"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>
    </button>

    <div class="container">
        <div class="header">
            <h1>Input Data Tanah</h1>
            <p>Formulir untuk memasukkan data tanah</p>
        </div>

        <form id="tanahDataForm">
            <div class="section-title">Data Utama</div>
            <div class="form-row">
                <div class="form-group">
                    <label for="lokasi_tanah">Lokasi Tanah</label>
                    <input type="text" id="lokasi_tanah" name="lokasi_tanah" required>
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="nomor_petak">Nomor Petak</label>
                    <input type="text" id="nomor_petak" name="nomor_petak">
                </div>
            </div>

            <div class="section-title">Data Luas</div>
            <div class="form-row">
                <div class="form-group">
                    <label for="luas_sertifikat">Luas Sertifikat (m²)</label>
                    <input type="number" id="luas_sertifikat" name="luas_sertifikat" step="0.01">
                </div>
                <div class="form-group">
                    <label for="luas_terukur">Luas Terukur (m²)</label>
                    <input type="number" id="luas_terukur" name="luas_terukur" step="0.01">
                </div>
            </div>

            <div class="section-title">Kondisi Tanah</div>
            <div class="form-row">
                <div class="form-group">
                    <label for="kondisi_tanah">Kondisi Tanah</label>
                    <select id="kondisi_tanah" name="kondisi_tanah">
                ...
                <div class="form-group">
                    ...
                    <select id="topografi" name="topografi">
                        <option value="datar">Datar</option>
                        <option value="bergerombol">Bergerombol</option>
    ...
    <script>
        ...
        document.getElementById('tanahDataForm').addEventListener('submit', async function(e) {
            e.preventDefault();
            ...
            const data = {
                ...
                lokasi_tanah: formData.get('lokasi_tanah'),
                nomor_sertifikat: formData.get('nomor_sertifikat') || null,
                blok: formData.get('blok') || null,
                nomor_petak: formData.get('nomor_petak') || null,
                luas_sertifikat: formData.get('luas_sertifikat') || null,
                luas_terukur: formData.get('luas_terukur') || null,
                kondisi_tanah: formData.get('kondisi_tanah') || 'baik',
                topografi: formData.get('topografi') || 'datar',
            ...
            try {
                ...
                if (result.success) {
                    Swal.fire('Berhasil', 'Data berhasil disimpan!', 'success').then(() => {
                        window.location.href = 'rekapan_pemeriksaan_tanah.php?id=' + idPekerjaan;
                    });
                } else {
