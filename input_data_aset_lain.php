...
<head>
    ...
    <title>Input Data Aset Lain</title>
    <style>
...
<body>
    <button class="back-btn" onclick="window.location.href='rekapan_pemeriksaan_aset_lain.php?id=' + new URLSearchParams(window.location.search).get('id_pekerjaan')">
        <svg viewBox="0 0 24 24"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>
    </button>

    <div class="container">
        <div class="header">
            <h1>Input Data Aset Lain</h1>
            <p>Formulir untuk memasukkan data aset tetap lainnya</p>
        </div>

        <form id="asetLainDataForm">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="jenis_aset" name="jenis_aset" placeholder="Furniture, Vehicle, IT Equipment, dll">
                </div>
                <div class="form-group">
                    <label for="tahun_perolehan">Tahun Perolehan</label>
                    <input type="number" id="tahun_perolehan" name="tahun_perolehan" min="1900" max="2100">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="kondisi_fungsi">Kondisi Fungsi</label>
                    <select id="kondisi_fungsi" name="kondisi_fungsi">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="kelengkapan" name="kelengkapan">
    ...
    <script>
        ...
        document.getElementById('asetLainDataForm').addEventListener('submit', async function(e) {
            e.preventDefault();
            ...
            const data = {
                ...
                kode_aset: formData.get('kode_aset') || null,
                merk: formData.get('merk') || null,
                model: formData.get('model') || null,
                jenis_aset: formData.get('jenis_aset') || null,
                tahun_perolehan: formData.get('tahun_perolehan') || null,
                kondisi_umum: formData.get('kondisi_umum') || 'baik',
                kondisi_fungsi: formData.get('kondisi_fungsi') || 'berfungsi',
                kelengkapan: formData.get('kelengkapan') || 'lengkap',
            ...
            try {
                ...
                if (result.success) {
                    Swal.fire('Berhasil', 'Data berhasil disimpan!', 'success').then(() => {
                        window.location.href = 'rekapan_pemeriksaan_aset_lain.php?id=' + idPekerjaan;
                    });
                } else {
